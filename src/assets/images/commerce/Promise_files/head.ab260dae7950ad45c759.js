var head = (function(t) {
  ...
  10: function(t, e) {
    function n(t) {
      if (
        ...
        (this.class = t.class ? " " + t.class : ""),
        (this.elemClass = t.elemClass),
  ...
  130: function(t, e) {
    function n() {
      ...
      document.querySelector(".page").classList.toggle("page_sidebar_on"),
        t && t.classList.toggle("page-wrapper_sidebar_on"),
        ...
        function t() {
          ...
          if (--e >= 0) {
            let t =
                ...
                n[e].firstElementChild.getAttribute("href"),
              r = document.querySelector(
                '.sidebar__navigation-link a[href="' + t + '"]'
              )
    ...
    t.exports = function() {
      if (n)
        return new Intl.DateTimeFormat([], {
          ...
          .find(t => "timeZoneName" == t.type).value
  ...
  146: function(t, e, n) {
    ...
    t.exports = class {
      constructor(t) {
        ;(this.elem = t),
          (this.renderPromise = new Promise((t, e) => {
      ...
      async render() {
        ...
        this.elem.append(t),
          (this.widgetId = grecaptcha.render(t, {
      ...
      async validateForm(t) {
        ...
        let e = await this.execute(),
          n = t.elements["g-recaptcha-response"]
        n ||
          (((n = document.createElement("input")).name =
    ...
    var r = n(113),
      ...
      u = function(t, e, n) {
        var l,
          ...
          p = t & u.P,
          y = t & u.B,
          g = m ? r : _ ? r[e] || (r[e] = {}) : (r[e] || {}).prototype,
          w = m ? i : i[e] || (i[e] = {}),
          v = w.prototype || (w.prototype = {})
        for (l in (m && (n = e), n))
          (d = ((c = !f && g && void 0 !== g[l]) ? g : n)[l]),
            (h =
              y && c
                ? a(d, r)
                : p && "function" == typeof d
  ...
  210: function(t, e, n) {
    ...
    class o extends HTMLElement {
      ...
      render() {
        ...
        if (((this.lastParams = t), "{" === this.getAttribute("except")[0]))
          return
        if (!this.getAttribute("except")) return
        let e = this.getAttribute("except")
            .split(",")
            .map(t => new Date(t)),
          n = []
    ...
    ;(window.DateExceptElement = o),
      window.customElements.define("date-except", o)
  },
  213: function(t, e) {
    let n
    t.exports = async function() {
      if (window.RECAPTCHA_ID)
        return (
          n ||
          (n = new Promise((t, e) => {
    ...
    t.exports = async function() {
      ...
      if (t.length) {
        ...
        for (let e of t) {
          ...
          ;(t.onsubmit = async e => {
            e.preventDefault(),
              await n.validateForm(t),
              t.checkValidity() ? t.submit() : t.reportValidity()
          }),
            (e.disabled = !1)
        }
      }
  ...
  293: function(t, e, n) {
    function r(t) {
      if (t.length) {
        if (1 === t.length)
          return "string" == typeof t[0] ? document.createTextNode(t[0]) : t[0]
        {
          let e,
    ...
    let i = {
      ...
      after: function() {
        this.parentNode &&
          this.parentNode.insertBefore(r(arguments), this.nextSibling)
      },
      closest: function(t) {
        let e = this
        for (; e; ) {
    ...
    if (
      ...
      let t = {
        ...
        get: function() {
          ...
          for (t = 0; t < u; t++)
            if ((o = a[t]) && o.name && /^data-\w[\w\-]*$/.test(o.name)) {
  ...
  296: function(t, e) {
    void 0 === document.documentElement.hidden &&
  ...
  298: function(t, e) {
    ;(function() {
        ...
        for (var o = t; o; ) {
          if (o.nodeType === Node.ELEMENT_NODE) {
            ...
            if ((s = s.__CE_shadowRoot))
              for (s = s.firstChild; s; s = s.nextSibling) i(s, e, n)
          }
      ...
      ;(s.prototype.connectedCallback = function(t) {
        ...
        (p.prototype.define = p.prototype.l),
        (p.prototype.upgrade = p.prototype.i),
        (p.prototype.get = p.prototype.get),
        (p.prototype.whenDefined = p.prototype.m),
        (p.prototype.polyfillWrapFlushCallback = p.prototype.s)
      var y = window.Document.prototype.createElement,
        ...
        v = window.Document.prototype.prepend,
        ...
        Y = window.Node.prototype.removeChild,
        ...
        C = window.Element.prototype.getAttribute,
        A = window.Element.prototype.setAttribute,
        P = window.Element.prototype.removeAttribute,
        H = window.Element.prototype.getAttributeNS,
        N = window.Element.prototype.setAttributeNS,
        ...
        R = window.Element.prototype.prepend,
        U = window.Element.prototype.append,
        I = window.Element.prototype.before,
        ...
        B = window.HTMLElement.prototype.insertAdjacentHTML,
        $ = new (function() {})()
      function X(t, e, r) {
        function i(e) {
          return function(r) {
            ...
            for (var s = [], a = 0; a < i.length; a++) {
              var u = i[a]
              if (
                (u instanceof Element && n(u) && s.push(u),
                u instanceof DocumentFragment)
              )
                for (u = u.firstChild; u; u = u.nextSibling) o.push(u)
              else o.push(u)
            }
            for (e.apply(this, i), i = 0; i < s.length; i++) c(t, s[i])
            if (n(this))
              for (i = 0; i < o.length; i++)
                (s = o[i]) instanceof Element && l(t, s)
          }
        }
        void 0 !== r.h && (e.prepend = i(r.h)),
          void 0 !== r.append && (e.append = i(r.append))
      }
      var K,
        ...
        ;(K = tt),
          (window.HTMLElement = (function() {
            function t() {
              ...
              return (
                (n[e] = $), Object.setPrototypeOf(r, t.prototype), u(K, r), r
              )
            }
            return (
          ...
          (function() {
            ...
            o(Document.prototype, "createElement", function(e) {
              ...
              o(Document.prototype, "importNode", function(e, n) {
                return (
                  (e = w.call(this, e, !!n)),
                  this.__CE_hasRegistry ? d(t, e) : a(t, e),
                  e
                )
              }),
          ...
          (function() {
              ...
              Object.defineProperty(t, "textContent", {
                ...
                set: function(t) {
                  if (this.nodeType === Node.TEXT_NODE) r.set.call(this, t)
                    ...
                    if ((r.set.call(this, t), i))
                      for (t = 0; t < i.length; t++) c(e, i[t])
                  }
                },
              })
            }
            ...
            o(Node.prototype, "insertBefore", function(t, r) {
              ...
              o(Node.prototype, "appendChild", function(t) {
                if (t instanceof DocumentFragment) {
                  ...
                  if (((t = T.call(this, t)), n(this)))
                    for (var i = 0; i < r.length; i++) l(e, r[i])
                  return t
                }
                return (
                  (r = n(t)),
              ...
              o(Node.prototype, "cloneNode", function(t) {
                return (
                  (t = D.call(this, !!t)),
                  this.ownerDocument.__CE_hasRegistry ? d(e, t) : a(e, t),
                  t
                )
              }),
              ...
              o(Node.prototype, "replaceChild", function(t, r) {
                if (t instanceof DocumentFragment) {
                  var i = Array.prototype.slice.apply(t.childNodes)
                  if (((t = L.call(this, t, r)), n(this)))
                    for (c(e, r), r = 0; r < i.length; r++) l(e, i[r])
                  return t
                }
                i = n(t)
                var o = L.call(this, t, r),
                  s = n(this)
          ...
          (function() {
            ...
            function e(t, e) {
              o(t, "insertAdjacentElement", function(t, r) {
                var i = n(r)
                return (
                  (t = e.call(this, t, r)), i && c(s, r), n(t) && l(s, r), t
                )
              })
            }
            function r(t, e) {
            ...
            var s = tt
            x &&
              o(Element.prototype, "attachShadow", function(t) {
                t = x.call(this, t)
                var e = s
              ...
              o(Element.prototype, "setAttribute", function(t, e) {
                ...
                A.call(this, t, e),
                  (e = C.call(this, t)),
                  s.attributeChangedCallback(this, t, n, e, null)
              }),
              o(Element.prototype, "setAttributeNS", function(t, e, n) {
                if (1 !== this.__CE_state) return N.call(this, t, e, n)
                var r = H.call(this, t, e)
                N.call(this, t, e, n),
                  (n = H.call(this, t, e)),
                  s.attributeChangedCallback(this, e, r, n, t)
              }),
              o(Element.prototype, "removeAttribute", function(t) {
                ...
                P.call(this, t),
                  null !== e &&
                    s.attributeChangedCallback(this, t, e, null, null)
              }),
              ...
              Z ? e(HTMLElement.prototype, Z) : W && e(Element.prototype, W),
              B ? r(HTMLElement.prototype, B) : j && r(Element.prototype, j),
              ...
              (function(t) {
                ...
                void 0 !== I && (r.before = e(I)),
                  void 0 !== I && (r.after = e(G)),
                  void 0 !== V &&
                    o(r, "replaceWith", function(e) {
                      ...
                      for (var o = [], s = 0; s < r.length; s++) {
                        var a = r[s]
                        if (
                          (a instanceof Element && n(a) && o.push(a),
                      ...
                      for (
                        s = n(this), V.apply(this, r), r = 0;
                        r < o.length;
                        r++
                      )
                        c(t, o[r])
                      if (s)
                        for (c(t, this), r = 0; r < i.length; r++)
                          (o = i[r]) instanceof Element && l(t, o)
                    }),
                  void 0 !== z &&
                    o(r, "remove", function() {
                      var e = n(this)
    ...
    n(20),
      ...
      String.prototype.endsWith ||
        (String.prototype.endsWith = function(t) {
          let e = arguments.length < 2 ? this.length : arguments[1],
  ...
  300: function(t, e, n) {
    let r = n(10)
    for (let t of document.querySelectorAll("[data-action-login]"))
      for (let e of t.classList) e.endsWith("_unready") && t.classList.remove(e)
    function i(t) {
      let e = new Modal({
          hasClose: !1,
  ...
  301: function(t, e) {
    ...
    document.addEventListener("click", function(t) {
      t.target.hasAttribute("data-action-user-logout") &&
        (t.preventDefault(), n())
    }),
      (t.exports = n)
  },
  302: function(t, e, n) {
    const r = n(665).loadDisqus,
      i = n(665).loadDisqusComments,
      o = n(665).loadDisqusIfVisible
    let s
    let a = 840
    function u() {
      s ||
          ...
          !(function() {
            ...
            if (e) {
              const n = document.querySelector(".page"),
                r =
                  n.classList.contains("page_profile") &&
                  "flex" === getComputedStyle(n).display
                    ? 0
                    : Math.max(t.getBoundingClientRect().bottom, 0) + "px"
              ;(e.style.top = r),
                (function() {
                  ...
                  let e = t.querySelector(".sidebar__content"),
                    n = t.querySelector(".sidebar__inner"),
                    r = t.classList.contains("sidebar_sticky-footer")
                  if (t.classList.contains("sidebar_compact")) {
                    let n
                    ;(n = r
                      ? e.lastElementChild.getBoundingClientRect().top -
                        e.lastElementChild.previousElementSibling.getBoundingClientRect()
                          .bottom
                      : e.getBoundingClientRect().bottom -
                        e.lastElementChild.getBoundingClientRect().bottom) >
                      150 && t.classList.remove("sidebar_compact")
                  } else
                    n.scrollHeight,
                      n.clientHeight,
            ...
            ;(function() {
              let t = document.documentElement.clientWidth <= a,
                e = document.querySelector('meta[name="viewport"]').content
              ;(e = e.replace(
                /user-scalable=\w+/,
                "user-scalable=" + (t ? "yes" : "no")
              )),
                (document.querySelector('meta[name="viewport"]').content = e)
            })(),
              o()
          })(),
            (s = null)
    ...
    window.addEventListener("resize-internal", u),
  ...
  303: function(t, e) {
    document.addEventListener("click", function(t) {
      ...
      t.target.closest(i + "__search-toggle") &&
        (n ||
          (function() {
            let t,
              e = document.querySelector(i),
              r = e.querySelector(i + "__search-input input")
      ...
      document.addEventListener("click", function(t) {
        ...
        if (!e) return
        e.nextElementSibling.style.display = e.nextElementSibling.offsetWidth
          ? "none"
          : "block"
      }),
      document.addEventListener("click", function(t) {
        ...
        t.target.classList.toggle("sitetoolbar__nav-toggle_active"),
          document
            .querySelector(".sitetoolbar")
            .classList.toggle("sitetoolbar_menu_open")
      })
    let n = !1,
      r = "sitetoolbar",
      i = "." + r
    function o() {
      ...
      e.classList.contains(r + "_search_open")
        ? (n.focus(),
          ((t = document.createElement("div")).className = "search-paranja"),
  ...
  305: function(t, e, n) {
    function r() {
      ...
      e &&
        ((t = document.querySelector(
          'a[href="' + e.getAttribute("href") + '"] .page__nav-text-shortcut'
        )).innerHTML = 'Ctrl + <span class="page__nav-text-arr">→</span>')
      let n = document.querySelector('link[rel="prev"]')
      n &&
        ((t = document.querySelector(
          'a[href="' + n.getAttribute("href") + '"] .page__nav-text-shortcut'
        )).innerHTML = 'Ctrl + <span class="page__nav-text-arr">←</span>')
    }
    n(306)(document, {
      onRight: function() {
    ...
    t.exports = function(t, e) {
      ...
      t.addEventListener("touchstart", function(t) {
        ...
        t.addEventListener("touchend", function(t) {
          let e = t.changedTouches[0]
          if (
            ((i = e.pageX - n), (o = Date.now() - s), Math.abs(e.pageY - r) > l)
          )
            return
          if (o > d) return
          let h = !1,
  ...
  307: function(t, e) {
    ...
    document.addEventListener("mouseover", function(t) {
      if (!t.target.closest) return
      let e =
        t.target.closest("[data-add-class-on-hover]") ||
      ...
      document.addEventListener("mouseout", function(t) {
        n &&
          (n.contains(t.relatedTarget) ||
            (n.classList.remove("hover"), (n = null)))
      }),
  ...
  309: function(t, e, n) {
    ...
    document.addEventListener("click", function(t) {
      ...
      e &&
        ((localStorage["hideBanner" + e.dataset.bannerClose] = 1),
  ...
  310: function(t, e, n) {
    ...
    class o extends HTMLElement {
      ...
      render() {
        let t = ["timestamp", "from", "to", "format"]
          .map(t => this.getAttribute(t))
          .join(":")
        if (this.lastParams === t) return
        if (((this.lastParams = t), this.getAttribute("timestamp"))) {
          if ("{" === this.getAttribute("timestamp")[0]) return
          return void (this.innerHTML = this.format(
            this.getAttribute("timestamp"),
            this.getAttribute("format"),
            this.hasAttribute("with-zone")
          ))
        }
        let e = []
        if (
          "{" === this.getAttribute("from")[0] ||
          "{" === this.getAttribute("to")[0]
        )
          return
        let n = new Date(this.getAttribute("from")),
          r = new Date(this.getAttribute("to")),
          i = this.getAttribute("format"),
          o = this.getAttribute("format")
        n.getFullYear() === r.getFullYear() &&
          (i = i.replace(/ YY(YY)?$/g, "")),
          (n.getFullYear() === r.getFullYear() &&
            n.getMonth() === r.getMonth() &&
            n.getDate() === r.getDate()) ||
            e.push(this.format(n, i)),
          e.push(this.format(r, o, this.hasAttribute("with-zone"))),
          (this.innerHTML = e.join(" – "))
      }
    }
    ;(window.DateLocalElement = o),
      window.customElements.define("date-local", o)
  },
  311: function(t, e, n) {
    let r = n(53),
      i = n(144),
    ...
    class a extends HTMLElement {
      ...
      render() {
        ...
        let t = ["weekdays", "with-zone", "from", "to"]
          .map(t => this.getAttribute(t))
          .join(":")
        if (this.lastParams === t) return
        this.lastParams = t
        let e,
          n = this.getAttribute("weekdays")
            .split(",")
            .map(Number),
          r = this.getAttribute("from"),
          a = this.getAttribute("to")
        if (
          (([n, r, a] = o(n, r, a, -new Date().getTimezoneOffset())),
          (e =
            "ru" === s
              ? ["", "пн", "вт", "ср", "чт", "пт", "сб", "вс"]
              : ["", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]),
          (n = n.map(t => e[t])),
          (n = "ru" === s ? n.join("/") : n.join(", ")),
          this.hasAttribute("with-zone"))
        ) {
          let t = i()
          this.setAttribute(
            "data-tooltip",
            "Время указано в вашем часовом поясе,<br>по данным браузера это " +
              t
          )
        }
    ...
    ;(window.WeekRangeElement = a),
      window.customElements.define("week-range", a)
  },
  312: function(t, e) {
    t.exports = function(t, e, n, r) {
      ;(r = +r),
        e.split && (e = e.split(":").map(Number)),
        n.split && (n = n.split(":").map(Number)),
        (e = 60 * e[0] + e[1] + r),
        (n = 60 * n[0] + n[1] + r),
        e < 0
          ? ((e += 1440), (n += 1440), (t = t.map(t => (1 === t ? 7 : t - 1))))
          : e >= 1440 &&
            ((e -= 1440), (n -= 1440), (t = t.map(t => (7 === t ? 1 : t + 1)))),
        n > 1440 && (n -= 1440),
        n < 0 && (n += 1440)
      let i = t => (0 === t ? "00" : t < 10 ? "0" + t : t)
      return [
        t,
        (e = [Math.floor(e / 60), e % 60].map(i).join(":")),
        (n = [Math.floor(n / 60), n % 60].map(i).join(":")),
      ]
    }
  },
  327: function(t, e, n) {
      ...
      t.exports = (function() {
        ...
        function k(t, e) {
          ...
          return h(function() {
            if (
              ...
              T((Array.prototype.slice.call(o).join(""), new Error().stack)),
                (n = !1)
            }
        ...
        function N(t) {
          var e,
            n,
            r = {}
          for (n in t) d(t, n) && (e = H(n)) && (r[e] = t[n])
          return r
        }
        var F = {}
        function W(t, e) {
        ...
        function q(t, e) {
          ...
          for (U.lastIndex = 0; n >= 0 && U.test(t); )
            (t = t.replace(U, r)), (U.lastIndex = 0), (n -= 1)
          return t
        }
        var J = /\d/,
          Z = /\d\d/,
        ...
        var Pt = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
          Ht = "January_February_March_April_May_June_July_August_September_October_November_December".split(
            "_"
          ),
        ...
        function zt(t, e, n) {
          ...
          return (
            s < 1
              ? ((i = t.year() - 1), (r = s + qt(i, e, n)))
              : s > qt(t.year(), e, n)
              ? ((r = s - qt(t.year(), e, n)), (i = t.year() + 1))
              : ((i = t.year()), (r = s)),
            {
              week: r,
              year: i,
        ...
        var Zt = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
            "_"
          ),
        ...
        function te() {
          ...
          for (e = 0; e < 7; e++)
            (n = f([2e3, 1]).day(e)),
              ...
              l.push(i),
              l.push(o)
          for (s.sort(t), a.sort(t), u.sort(t), l.sort(t), e = 0; e < 7; e++)
            (a[e] = ht(a[e])), (u[e] = ht(u[e])), (l[e] = ht(l[e]))
        ...
        V("H", ["HH", 2], 0, "hour"),
          ...
          V("hmmss", 0, 0, function() {
            return (
              "" + ee.apply(this) + j(this.minutes(), 2) + j(this.seconds(), 2)
            )
          }),
          V("Hmm", 0, 0, function() {
          ...
          return (
            n &&
              ...
              ((e =
                n[gt] < 0 || n[gt] > 11
                  ? gt
                  : n[wt] < 1 || n[wt] > At(n[yt], n[gt])
                  ? wt
                  : n[vt] < 0 ||
                    n[vt] > 24 ||
                    (24 === n[vt] &&
                      (0 !== n[Mt] || 0 !== n[bt] || 0 !== n[St]))
                  ? vt
                  : n[Mt] < 0 || n[Mt] > 59
                  ? Mt
                  : n[bt] < 0 || n[bt] > 59
                  ...
                  ? St
                  : -1),
              m(t)._overflowDayOfYear && (e < yt || e > wt) && (e = wt),
              m(t)._overflowWeeks && -1 === e && (e = Dt),
              m(t)._overflowWeekday && -1 === e && (e = Tt),
              (m(t).overflow = e)),
            t
          )
        }
          ...
          if (!t._d) {
            for (
              r = (function(t) {
                ...
                t._w &&
                  ...
                  (function(t) {
                    ...
                    if (null != (e = t._w).GG || null != e.W || null != e.E)
                      (o = 1),
                        (s = 4),
                        (n = _e(e.GG, t._a[yt], zt(Oe(), 1, 4).year)),
                        (r = _e(e.W, 1)),
                        ((i = _e(e.E, 1)) < 1 || i > 7) && (u = !0)
                    else {
                      ;(o = t._locale._week.dow), (s = t._locale._week.doy)
                      var l = zt(Oe(), o, s)
                      ;(n = _e(e.gg, t._a[yt], l.year)),
                        (r = _e(e.w, l.week)),
                        null != e.d
                          ? ((i = e.d) < 0 || i > 6) && (u = !0)
                          : null != e.e
                ...
                null != t._dayOfYear &&
                  ((s = _e(t._a[yt], r[yt])),
                  (t._dayOfYear > kt(s) || 0 === t._dayOfYear) &&
                    (m(t)._overflowDayOfYear = !0),
                  (n = It(s, 0, t._dayOfYear)),
            ...
            24 === t._a[vt] &&
              ...
              (t._d = (t._useUTC
                ...
                : function(t, e, n, r, i, o, s) {
                    ...
                    return (
                      t < 100 && t >= 0
                        ? ((a = new Date(t + 400, e, n, r, i, o, s)),
                          isFinite(a.getFullYear()) && a.setFullYear(t))
                        : (a = new Date(t, e, n, r, i, o, s)),
                      a
                    )
                  }
              ).apply(null, a)),
          ...
          if (t._f !== i.ISO_8601)
            if (t._f !== i.RFC_2822) {
              ...
              var e,
                ...
                l = 0
              for (
                r = q(t._f, t._locale).match(R) || [], e = 0;
                e < r.length;
                e++
              )
                (o = r[e]),
                  (n = (a.match(dt(o, t)) || [])[0]) &&
                    ((s = a.substr(0, a.indexOf(n))).length > 0 &&
                      m(t).unusedInput.push(s),
                    (a = a.slice(a.indexOf(n) + n.length)),
                    (l += n.length)),
                  G[o]
                    ? (n ? (m(t).empty = !1) : m(t).unusedTokens.push(o),
                      pt(o, n, t))
                    : t._strict && !n && m(t).unusedTokens.push(o)
              ;(m(t).charsLeftOver = u - l),
        ...
        function Ne(t) {
          ...
          ;(this._isValid = (function(t) {
            for (var e in t)
              if (-1 === Lt.call(He, e) || (null != t[e] && isNaN(t[e])))
                return !1
            for (var n = !1, r = 0; r < He.length; ++r)
              if (t[He[r]]) {
                if (n) return !1
                parseFloat(t[He[r]]) !== S(t[He[r]]) && (n = !0)
              }
            return !0
          })(e)),
        ...
        function Ie(t, e) {
          ...
          return e._isUTC
            ? ((n = e.clone()),
              (r =
                (M(t) || l(t) ? t.valueOf() : Oe(t).valueOf()) - n.valueOf()),
          ...
          return (
            Fe(t)
              ...
              : "object" == typeof l &&
                ...
                (i =
                  o.isValid() && s.isValid()
                    ? ((s = Ie(s, o)),
                      o.isBefore(s)
                        ? (a = Be(o, s))
                        : (((a = Be(s, o)).milliseconds = -a.milliseconds),
                          (a.months = -a.months)),
                      a)
                    : {
                        milliseconds: 0,
                ...
                (l.M = i.months)),
            (r = new Ne(l)),
            Fe(t) && d(t, "_locale") && (r._locale = t._locale),
            r
          )
        }
        function Ze(t, e) {
          ...
          return function(n, r) {
            ...
            return (
              null === r ||
                ...
                (n = r),
                (r = i)),
              Xe(this, Je((n = "string" == typeof n ? +n : n), r), t),
              this
            )
          }
        }
        function Xe(t, e, n, r) {
          ...
          t.isValid() &&
            ((r = null == r || r),
            a && Ft(t, Ot(t, "Month") + a * n),
            s && Ct(t, "Date", Ot(t, "Date") + s * n),
            o && t._d.setTime(t._d.valueOf() + o * n),
            r && i.updateOffset(t, s || a))
        }
        ;(Je.fn = Ne.prototype),
          (Je.invalid = function() {
            return Je(NaN)
        ...
        function tn(t, e) {
          ...
          return (
            e - o < 0
              ...
              : ((n = t.clone().add(i + 1, "months")), (r = (e - o) / (n - o))),
            -(i + r) || 0
          )
        }
        function en(t) {
          ...
          return void 0 === t
            ? this._locale._abbr
            : (null != (e = fe(t)) && (this._locale = e), this)
        }
        ...
        ;(vn.add = Ke),
          (vn.calendar = function(t, e) {
            var n = t || Oe(),
              r = Ie(n, this).startOf("day"),
              o = i.calendarFormat(this, r) || "sameElse",
              s = e && (x(e[o]) ? e[o].call(this, n) : e[o])
          ...
          (vn.diff = function(t, e, n) {
            ...
            switch (
              ((i = 6e4 * (r.utcOffset() - this.utcOffset())), (e = H(e)))
            ) {
              case "year":
                o = tn(this, r) / 12
                break
          ...
          (vn.endOf = function(t) {
            var e
            if (void 0 === (t = H(t)) || "millisecond" === t || !this.isValid())
              return this
            ...
            switch (t) {
              ...
              case "hour":
                ;(e = this._d.valueOf()),
                  (e +=
                    an -
                    ln(e + (this._isUTC ? 0 : this.utcOffset() * sn), an) -
                    1)
                break
          ...
          (vn.from = function(t, e) {
            return this.isValid() && ((M(t) && t.isValid()) || Oe(t).isValid())
              ? Je({
                  to: this,
                  from: t,
                })
          ...
          (vn.get = function(t) {
            return x(this[(t = H(t))]) ? this[t]() : this
          }),
          ...
          (vn.set = function(t, e) {
            ...
            else if (x(this[(t = H(t))])) return this[t](e)
            return this
          }),
          (vn.startOf = function(t) {
            ...
            switch (t) {
              ...
              case "hour":
                ;(e = this._d.valueOf()),
                  (e -= ln(e + (this._isUTC ? 0 : this.utcOffset() * sn), an))
                break
          ...
          (vn.utcOffset = function(t, e, n) {
            ...
            if (null != t) {
              ...
              return (
                !this._isUTC && e && (r = Ge(this)),
                (this._offset = t),
                (this._isUTC = !0),
                null != r && this.add(r, "m"),
                o !== t &&
                  (!e || this._changeInProgress
                    ? Xe(this, Je(t - o, "m"), 1, !1)
          ...
          (vn.dates = k("dates accessor is deprecated. Use date instead.", mn)),
          (vn.months = k(
            "months accessor is deprecated. Use month instead",
            Wt
          )),
          (vn.years = k("years accessor is deprecated. Use year instead", Et)),
          (vn.zone = k(
        ...
        ;(bn.calendar = function(t, e, n) {
          ...
          (bn.months = function(t, e) {
            return t
              ? o(this._months)
                ...
                : this._months[
                    (this._months.isFormat || Pt).test(e)
                      ? "format"
                      : "standalone"
                  ][t.month()]
              : o(this._months)
          ...
          (bn.monthsShort = function(t, e) {
            return t
              ? o(this._monthsShort)
                ...
                : this._monthsShort[Pt.test(e) ? "format" : "standalone"][
                    t.month()
                  ]
              : o(this._monthsShort)
              ? this._monthsShort
          ...
          (bn.monthsParse = function(t, e, n) {
            ...
            if (this._monthsParseExact)
              return function(t, e, n) {
                ...
                return n
                  ? "MMM" === e
                    ? -1 !== (i = Lt.call(this._shortMonthsParse, s))
                      ? i
                      : null
                    : -1 !== (i = Lt.call(this._longMonthsParse, s))
                    ? i
                    : null
                  : "MMM" === e
                  ? -1 !== (i = Lt.call(this._shortMonthsParse, s))
          ...
          (bn.monthsRegex = function(t) {
            return this._monthsParseExact
              ? (d(this, "_monthsRegex") || Ut.call(this),
          ...
          (bn.monthsShortRegex = function(t) {
            return this._monthsParseExact
              ...
              : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = jt),
          ...
          (bn.weekdaysParse = function(t, e, n) {
            ...
            if (this._weekdaysParseExact)
              return function(t, e, n) {
                ...
                return n
                  ? "dddd" === e
                    ? -1 !== (i = Lt.call(this._weekdaysParse, s))
                      ? i
                      : null
                    : "ddd" === e
                    ? -1 !== (i = Lt.call(this._shortWeekdaysParse, s))
                      ? i
                      : null
                    : -1 !== (i = Lt.call(this._minWeekdaysParse, s))
                    ? i
                    : null
                  : "dddd" === e
                  ? -1 !== (i = Lt.call(this._weekdaysParse, s))
          ...
          (bn.weekdaysRegex = function(t) {
            return this._weekdaysParseExact
              ? (d(this, "_weekdaysRegex") || te.call(this),
          ...
          (bn.weekdaysMinRegex = function(t) {
            return this._weekdaysParseExact
              ...
              : (d(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Qt),
        ...
        function Qn() {
          ...
          if (!d) return "P0D"
          var h = d < 0 ? "-" : "",
            f = Kn(this._months) !== Kn(d) ? "-" : "",
            m = Kn(this._days) !== Kn(d) ? "-" : "",
            _ = Kn(this._milliseconds) !== Kn(d) ? "-" : ""
          return (
            h +
            "P" +
            (o ? f + o + "Y" : "") +
        ...
        return (
          ...
          (tr.as = function(t) {
            ...
            if ("month" === (t = H(t)) || "quarter" === t || "year" === t)
              switch (
                ((e = this._days + r / 864e5), (n = this._months + En(e)), t)
              ) {
                case "month":
                  return n
    ...
    t.exports = function(t) {
      return function(e, n, s) {
        ...
        if (t && n != n) {
          ...
          for (; l > c; c++) if ((t || c in u) && u[c] === n) return t || c || 0
        return !t && -1
      }
    }
  },
  ...
  449: function(t, e, n) {
    t.exports =
      ...
      !n(93)(function() {
        return (
          7 !=
          Object.defineProperty(n(424)("div"), "a", {
            get: function() {
              return 7
            },
          }).a
  ...
  58: function(t, e, n) {
    ...
    ;(e.iframe = function(t) {
      ...
      (e.codeTabs = function(t) {
        function e() {
          let e = t.closest(".code-tabs"),
            n =
              (t.closest("[data-code-tabs-content]"),
              e.querySelector("[data-code-tabs-switches]"))
          n.firstElementChild.offsetWidth > n.offsetWidth
            ? e.classList.add("code-tabs_scroll")
            : e.classList.remove("code-tabs_scroll")
        }
        e(), o.push(e)
      }),
  ...
  60: function(t, e, n) {
    ...
    t.exports = function(t) {
      ...
      return (
        t.documentElement.scrollWidth > t.documentElement.clientWidth &&
          (r || (r = i()), (e += r)),
        e
      )
    }
  ...
  61: function(t, e) {
    t.exports = function() {
      let t = document.createElement("div")
      if (
        ((t.style.cssText = "visibility:hidden;height:100px"), !document.body)
      )
  ...
  665: function(t, e) {
    const n = "//" + window.disqus_shortname + ".disqus.com/embed.js",
      r = "//" + window.disqus_shortname + ".disqus.com/count.js"
    function i() {
    ...
    ;(e.loadDisqus = i),
      (e.loadDisqusComments = function() {
        const t = document.getElementById("disqus_comments")
        if (!t) return
        window.disqus_config(),
          (t.dataset.disqusIdentifier = window.page.identifier)
      ...
      (e.loadDisqusIfVisible = function() {
        ...
        e.top > document.documentElement.clientHeight + 150 ||
          e.bottom < -150 ||
          i()
      })
  },
