...
*/
  ...
  function Y(a, b, c, d) {
    c.href &&
      ((a = V(a, b, c.href, void 0 === d ? !1 : d)), w.test(a) && (c.href = a))
  }
  function X(a, b, c) {
    if (c && c.action) {
      ...
      if ("get" === d) {
        ...
        f ||
          ((d = u.createElement("input")),
          d.setAttribute("type", "hidden"),
          d.setAttribute("name", a),
          d.setAttribute("value", b),
          c.appendChild(d))
      } else
        "post" === d && ((a = V(a, b, c.action)), w.test(a) && (c.action = a))
    }
  }
  var K = function(a) {
      try {
        ...
        if (a.get(je)) {
          ...
          if (c) {
            ...
            g && "aw.ds" != g
              ...
              : ((c = ["1", e, Cc(c)].join(".")),
                0 < d &&
                  (b && (b.ta = !0), zc("_gac_" + Cc(k), c, ca, l, k, d, w)))
            le(b)
          }
        } else J(75)
